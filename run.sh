...
python3 ./__main__.py --uri "tcp://0.0.0.0:10200" --subscription-key "${SUBSCRIPTION_KEY}" --service-region "${SERVICE_REGION}" --custom-voice "${CUSTOM_VOICE}" --endpoint-id "${ENDPOINT_ID}" --download-dir /data
